...
# This creates a persistent "Chrome" identity for all your requests
...
# Industry Benchmarks [P/E, ROE, D/E]
INDUSTRY_AVGS = {
...
def get_pro_data(symbol):
    try:
        # Use the impersonated session here
...
if analyze_btn:
    ...
    with st.expander(L["logic_header"], expanded=True):
        ...
        st.write("This engine uses **Browser Impersonation (TLS Fingerprinting)** to ensure stable data access from Yahoo Finance.")
